...
$ShopAccess->select(cmIdCheck(constant("ShopAccess::keyName")), "1", cmIdCheck(constant("ShopAccess::keyName")));
$ShopAccess->setByKey($ShopAccess->getKeyValue(), "COMPANY_ID", cmIdCheck(constant("ShopAccess::keyName")));
$ShopAccess->setPost();
$ShopAccess->check();

$hotelPic = new hotelPic($dbMaster);
$hotelPic->select("", "1,2", cmIdCheck(constant("ShopAccess::keyName")));
