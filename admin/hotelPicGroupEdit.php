...
$hotelPicGroup->select(cmIdCheck(constant("hotelPicGroup::keyName")), "", cmKeyCheck(constant("hotel::keyName")));
$hotelPicGroup->setByKey($hotelPicGroup->getKeyValue(), "COMPANY_ID", cmKeyCheck(constant("hotel::keyName")));
