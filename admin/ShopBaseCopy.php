...
$hotelShopBaseOrigin->select(cmIdCheck(constant("hotelShopBase::keyName")), "1", cmIdCheck(constant("shop::keyName")));

$hotelShopBase = new hotelShopBase($dbMaster);
$hotelShopBase->setByKey($hotelShopBase->getKeyValue(), "COMPANY_ID", cmIdCheck(constant("shop::keyName")));
