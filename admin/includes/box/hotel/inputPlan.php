...
<table border="0" cellpadding="0" cellspacing="15" id="common" width="100%">
	...
	<tr>
		<th valign="top">
			<p>プランの特徴・おすすめポイント <span class="colorRed">※</span></p>
		</th>
		<td align="left">
	...
	<tr>
		...
		<td align="left">
			...
			<?=$inputs->image("SHOPPLAN_PIC1", $shopPlan->getByKey($shopPlan->getKeyValue(), "SHOPPLAN_PIC1"), IMG_HOTEL_APP_WIDTH, IMG_HOTEL_APP_HEIGHT, IMG_HOTEL_APP_SIZE, "", 3)?>
				...
				<a href="hotelGalleryEdit.html?id=SHOPPLAN_PIC1" class="popup" rel="windowCallUnload"></a>
				...
				<a href="hotelGalleryEdit.html?id=SHOPPLAN_PIC1" class="popup" rel="windowCallUnload"><?=$inputs->button("","","設定済写真から選択","circle")?></a>
				<?php }?>
	...
	<tr>
		...
		<td align="left">
			...
			<?=$inputs->image("SHOPPLAN_PIC".$i, $shopPlan->getByKey($shopPlan->getKeyValue(), "SHOPPLAN_PIC".$i), IMG_HOTEL_APP_WIDTH, IMG_HOTEL_APP_HEIGHT, IMG_HOTEL_APP_SIZE, "", 3)?>
				...
				<?php if ($hotelPic->getCount() > 0) {?>
				<a href="hotelGalleryEdit.html?id=SHOPPLAN_PIC<?php print $i?>" class="popup" rel="windowCallUnload"></a>
				...
				<a href="hotelGalleryEdit.html?id=SHOPPLAN_PIC<?php print $i?>" class="popup" rel="windowCallUnload"><?=$inputs->button("","","設定済写真から選択","circle")?></a>
				<?php }?>
