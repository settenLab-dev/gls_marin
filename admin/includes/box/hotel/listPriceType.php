...
<table cellspacing="0" cellpadding="5" class="tblInput " id="sortList" width="100%">
	...
	<tbody>
		...
		<tr>
			...
			<a href="shopPriceTypeEdit.html?id=<?=$ad["COMPANY_ID"]?>&key=<?=$ad["SHOP_PRICETYPE_ID"]?>" class="popup" rel="windowCallUnload"><?=$inputs->button("","","編集","circle")?></a>

			</td>
			<td <?=$rclass?> align="center">

			<a href="ShopPriceEdit.html?id=<?=$ad["COMPANY_ID"]?>&key=<?=$ad["SHOP_PRICETYPE_ID"]?>" class="popup" rel="windowCallUnload"><?=$inputs->button("","","料金登録","circle")?></a>
