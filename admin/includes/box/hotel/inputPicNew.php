<table border="0" cellpadding="0" cellspacing="15" class="" summary="マスタデータ" width="100%">
	...
	<tr>
		...
		<td align="left">
			...
			<select name="HOTELPICGROUP_ID" class="circle">
				<option value="">---</option>
				<option value="-1" <?php print ($hotelPic->getByKey($hotelPic->getKeyValue(), "HOTELPICGROUP_ID")==-1)?'selected="selected"':''?>>体験風景</option>
				<option value="-2" <?php print ($hotelPic->getByKey($hotelPic->getKeyValue(), "HOTELPICGROUP_ID")==-2)?'selected="selected"':''?>>お客様</option>
	...
	<tr>
		<td width="160" valign="top">
			<p>ショップ画像 <span class="colorRed">※</span></p>
		</td>
		<td align="left">
	...
	<tr>
		...
		<td align="left">
			...
			<?php print $inputs->radio("HOTELPIC_STATUS2", "HOTELPIC_STATUS", 1, $hotelPic->getByKey($hotelPic->getKeyValue(), "HOTELPIC_STATUS") ," 公開")?>
