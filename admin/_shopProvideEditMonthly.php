...
$hotelProvide->select(cmIdCheck("HOTELPROVIDE_ID"), cmAdCheck(constant("hotelProvide::keyName")), cmKeyCheck("ROOM_ID"));
...
$hotelProvide->setByKey($hotelProvide->getKeyValue(), "COMPANY_ID", cmAdCheck(constant("hotelProvide::keyName")));
...
*/
$_POST['COMPANY_ID']=cmIdCheck(constant("hotelProvide::keyName"));
if ($hotelProvide->getByKey($hotelProvide->getKeyValue(), "regist") and $hotelProvide->getErrorCount() <= 0) {
