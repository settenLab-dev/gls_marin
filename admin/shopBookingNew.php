...
$shopBookset->select(cmIdCheck(constant("shop::keyName")));
...
<head>
	...
	<?php if (($shopBooking->getByKey($shopBookingcont->getKeyValue(), "regist") or $shopBooking->getByKey($shopBookingcont->getKeyValue(), "delete")) and $shopBooking->getErrorCount() <= 0) {?>
	window.close();
	<?php }?>
