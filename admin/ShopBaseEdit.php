...
$hotelShopBase->select(cmIdCheck(constant("hotelShopBase::keyName")), "1", cmIdCheck(constant("hotelShopBase::keyName")));
$hotelShopBase->setByKey($hotelShopBase->getKeyValue(), "COMPANY_ID", cmIdCheck(constant("hotelShopBase::keyName")));
$hotelShopBase->setPost();
$hotelShopBase->check();

$hotelPic = new hotelPic($dbMaster);
$hotelPic->select("", "1,2", cmIdCheck(constant("hotelShopBase::keyName")));
