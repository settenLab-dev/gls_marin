...
$hotelPic->select(cmIdCheck(constant("hotelPic::keyName")), "1,2", cmKeyCheck(constant("hotel::keyName")));
$hotelPic->setByKey($hotelPic->getKeyValue(), "COMPANY_ID", cmKeyCheck(constant("hotel::keyName")));
$hotelPic->setPost();
$hotelPic->check();
