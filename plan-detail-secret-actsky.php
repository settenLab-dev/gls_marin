	                    	...
	                    	<div class="aboutprice">
	                    		<div class="maxsell">
	                    			<h3>◆お支払いについて</h3>
	                    				...
	                    				<?php } else {?>
	                    				<p>・事前支払い<br/>
	                    				こちらのプランは事前支払い限定となります。<br/>
	                    				クレジットカード又はコンビニ支払い又は銀行振込又はご来店でのお支払からお選びいただけます。<br/>
	                    				※いずれの場合もツアーご予約の翌日から3日以内かつご利用日前日までにお支払いください。<br/>
	                    				※ご入金が確認できない場合はチケットの送信ができません。<br/>
	                    				<a href="http://cocotomo.net/sky-pay.html" target="blank">⇒お支払い方法についての詳細はこちら</a><br/></p>
	                    				<?php }?>
