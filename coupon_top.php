...
<title>ココトモのクーポン「ココポン」沖縄限定のお得な購入クーポン♪<?php print SITE_PUBLIC_NAME?></title>
...
<!--header-->
<?php require("includes/box/common/header_coupon.php");?>
<!--/header-->
...
<section>
    <div class="mainimage">
    	<img src="./images/coupon/top_image.png" width="1321" height="322" alt="沖縄県民限定クーポン！ココトモ！のクーポン！ココポン！" /></a>
	</div>
</section>
   ...
   <article id="coupon_list">
	...
	<div class="first">
		...
		<a href="javascript:void(0)" onclick="document.<?php print $formname?>.submit();">
					...
					?>
		<div class="no1">
			<h2><U><?php print $plandata["COUPON_NAME"]?></U></h2>
