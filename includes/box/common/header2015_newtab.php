...
-->
						<form action="<?php print $_SERVER['REQUEST_URI']?>" method="post">
							<span><input type="submit"  name="logout" value="ログアウト" class="circle" /></span>
							<!--<a href="javascript:void(0)" onclick="document.logout.submit();">ログアウト</a>->
            ...
            <nav>
                <ul>
                    <li class="navi01"><a href="<?=URL_PUBLIC?>index.html" class="stay1">HOME</a></li>
                    <li class="navi02"><a href="<?=URL_PUBLIC?>n_hotel.html" class="link2">宿泊予約</a></li>
                    <li class="navi04"><a href="<?=URL_PUBLIC?>n_coupon.html" class="link4">クーポン</a></li>
                    <li class="navi06"><a href="<?=URL_PUBLIC?>gourmet-list.html" class="link6">グルメ</a></li>
                    <li class="navi05"><a href="<?=URL_PUBLIC?>leisure-list.html" class="link5">レジャー</a></li>
                    ...
                    <li class="navi08"><a href="<?=URL_PUBLIC?>save-points.html" class="link8">ポイント</a></li>
                </ul>
            </nav>
        </div>
    </div>
