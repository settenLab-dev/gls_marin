...
//                         $candate = date("Y年m月d日",strtotime("-".($d-1)." day" ,strtotime($hotelPay->getByKey($hotelPay->getKeyValue(), "HOTELPAY_DATE"))))
                ...
                <tbody>
                    <tr><th>お名前</th><td><textarea id="onamae" name="onamae" cols="*" lows="*" ></textarea></td></tr>
                    <tr><th>メールアドレス</th><td><textarea id="mailad" name="mailad" cols="*" lows="*" ></textarea><p class="small">※ご予約完了時にメールをお送りします。</p></td></tr>
                    <tr><th>ご住所</th>
                    <td>
                    <textarea id="ad" name="ad" cols="*" lows="*" ></textarea><br/>
                   <textarea id="ad2" name="ad2" cols="*" lows="*" ></textarea>
                    </td></tr>
                    <tr><th>電話番号</th><td> <textarea id="tel" name="tel" cols="*" lows="*" ></textarea><p class="small">※当日ご連絡がつく番号をご入力ください。</p></td></tr>
                </tbody>
                </table>
                </section>
                ...
                <table class="style5 ">
                <tbody>
                    <tr><th>レジャー施設<br>からの質問</th><td><?php print redirectForReturn($hotelPlan->getByKey($hotelPlan->getKeyValue(), "HOTELPLAN_QUESTION"))?></td></tr>
