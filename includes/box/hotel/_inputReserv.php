<section>
                ...
                <tbody>
                    ...
                    <tr><th>宿泊日</th><td><?php print $hotelPay->getByKey($hotelPay->getKeyValue(), "HOTELPAY_DATE")?></td></tr>
               ...
               <table class="style2">
                ...
                <?php for ($nightNum=1; $nightNum<=$collection->getByKey($collection->getKeyValue(), "night_number"); $nightNum++) {?>
                    ...
                    <tr>
                    	...
                    	?>
                    	￥<?php print number_format($hotelPayDsp->getByKey($nightNum, "money_all"))?>
                    	</td>
                    </tr>
	                	<?php for ($roomNum=1; $roomNum<=$collection->getByKey($collection->getKeyValue(), "room_number"); $roomNum++) {?>
                    <tr>
	                    ...
	                    <td>
	                    <p>大人<?php print $collection->getByKey($collection->getKeyValue(), "adult_number".$roomNum)?>人×￥<?php print number_format($hotelPayDsp->getByKey($nightNum, "money_".$roomNum))?>＝￥<?php print number_format($hotelPayDsp->getByKey($nightNum, "money_adult_".$roomNum))?></p>
	                    ...
	                    ?>
	                    <?php print $collection->getByKey($collection->getKeyValue(), "child_number".$roomNum.$child)?>人×￥<?php print number_format($hotelPayDsp->getByKey($nightNum, "money_child_".$roomNum."_".$child))?>＝￥<?php print number_format($hotelPayDsp->getByKey($nightNum, "money_child_".$roomNum."_".$child."_all"))?>
	                    </p>
		                    <?php }?>
	                    <?php }?>
	                    </td>
