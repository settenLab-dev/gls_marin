<section>
                ...
                <tbody>
                    ...
                    <tr><th>ご利用希望日</th><td><?php print $hotelPay->getByKey($hotelPay->getKeyValue(), "HOTELPAY_DATE")?></td></tr>
               ...
               <table class="style2">
                ...
                <div class="bottom">
                	<p>この内容で宜しければリクエストを送信ボタンをクリックして下さい。</p>
                	<table  border="0" style="border:none; width: 200px;" width="200">
                		<tr>
                			<td style="border:none;">
					<input type="image" src="images/reservation/btn_request.jpg" name="regist" value="この内容でリクエストする">
