...
<table cellspacing="0" cellpadding="5" class="tblInput cancel" id="sortList" width="100%">
				<thead>
					...
					<tr>
						<th class="subcon"><p>低学年</p></th>
						<th class="subcon"><p>高学年</p></th>
						<th class="subcon"><p>食・布</p></th>
						<th class="subcon"><p>食のみ</p></th>
						<th class="subcon"><p>布のみ</p></th>
						<th class="subcon"><p>なし</p></th>
					</tr>
				</thead>
			...
			<td align="left">
				...
				?>
				<a href="<?=URL_PUBLIC?>search-detail.html?undecide_sch=1&hid=<?=$hotelBooking->getByKey($hotelBooking->getKeyValue(), "COMPANY_ID")?>"><?=$hotel_name?></a></p>
			</td>
			</tr>
			<tr>
			<th width="160" valign="top">
			...
			<?php $tmp = $hotelBookingcont->getCollection();$tmp1=array_slice($tmp, 1);?>
				<p><?=$tmp1[0]["BOOKINGCONT_DATE"]." ".$hotelBooking->getByKey($hotelBooking->getKeyValue(), "BOOKING_CHECKIN")?></p>
			</td>
			</tr>
			<tr>
			<th width="160" valign="top">
