...
//                         $candate = date("Y年m月d日",strtotime("-".($d-1)." day" ,strtotime($hotelPay->getByKey($hotelPay->getKeyValue(), "HOTELPAY_DATE"))))
                        ?>
                        <td><b class="large red"><?php print $d?> <?php print $h?>時</b><p class="small">※上記の時間を過ぎた場合は、サイト上からキャンセルを行うことができません。<br>催行会社へ直接ご連絡ください。</p></td>
                    </tr>
                </tbody>
                </table>
                </section>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="radio-group">
                        	<div><!--現地決済-->
                        	<!--<input type="hidden" name="BOOKING_HOW" value="1" />-->
                ...
                <div class="bottom">
                    ...
                    <input type="image" src="images/reservation/request-reservation-submit.png" name="confirm" value="a">
                </div>
