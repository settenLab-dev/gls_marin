...
//                         $candate = date("Y年m月d日",strtotime("-".($d-1)." day" ,strtotime($hotelPay->getByKey($hotelPay->getKeyValue(), "HOTELPAY_DATE"))))
                ...
                */?>
                ...
                <table class="style5 space">
                <tbody>
                    <tr><th class="bg1"><b class="red">お支払金額</b><span>獲得するポイント</span></th><td class="price bg1"><b>￥<input type="hidden" id="BOOKING_MONEY" name="BOOKING_MONEY" value="<?php print $arPayList["money_all"]?>"><?php print number_format($arPayList["money_all"])?></b>（税込・サービス料込）</td></tr>
                    <tr>
                        <th>お支払方法</th>
