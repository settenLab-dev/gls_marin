...
array(
	new SoapVar(array(
				...
				new SoapVar(array(
						...
						new SoapVar($collection->getByKey($collection->getKeyValue(), "BOOKING_MONEY"), XSD_INTEGER, null, null, 'tllCharge'),
				...
				new SoapVar(array(
						...
						new SoapVar(array(
								...
								new SoapVar("glass space Inc.", XSD_STRING, null, null, 'SalesOfficeName'),
						...
						new SoapVar(array(
								...
								new SoapVar(mb_convert_kana($sess->getSessionByKey($sess->getSessionLogninKey(), "MEMBER_NAME_KANA1")." ".$sess->getSessionByKey($sess->getSessionLogninKey(), "MEMBER_NAME_KANA2"), "k", "utf-8"), XSD_STRING, null, null, 'GuestOrGroupNameSingleByte'),
								...
								new SoapVar($hotelBooking->getByKey($hotelBooking->getKeyValue(), "COUPON_ID_NUM"), XSD_STRING, null, null, 'SalesOfficeComment'),
								new SoapVar(array(
