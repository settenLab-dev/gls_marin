...
array(
		new SoapVar(array(
				...
				new SoapVar(array(
						...
						new SoapVar(array(
								new SoapVar("", XSD_STRING , null, null, 'tllRmTypeCode'),
								new SoapVar("", XSD_STRING, null, null, 'tllPlanCode')
						), SOAP_ENC_OBJECT, null, null, 'tllPlanInfos'),
...
// 							$tlPayment->setByKey($tlPayment->getKeyValue(), "TL_PAYMENT_DATE_UPDATE", $d->stockCount);
