...
for ($roomNum=1; $roomNum<=$collection->getByKey($collection->getKeyValue(), "room_number"); $roomNum++) {
	...
	$arRooms[$roomNum]["yuukou_ninnzuu"] += $collection->getByKey($collection->getKeyValue(), "child_number".$roomNum."3");
	$arRooms[$roomNum]["yuukou_ninnzuu"] += $collection->getByKey($collection->getKeyValue(), "child_number".$roomNum."5");
...
for ($nightNum=1; $nightNum<=$collection->getByKey($collection->getKeyValue(), "night_number"); $nightNum++) {
	...
	for ($roomNum=1; $roomNum<=$collection->getByKey($collection->getKeyValue(), "room_number"); $roomNum++) {
		...
		*/
		$arRooms[$roomNum]["kingaku_otona_otoko"] = $arPayList[$tdate][$roomNum]["money_adult"];
		$arRooms[$roomNum]["kingaku_otona_onna"] = $arPayList[$tdate][$roomNum]["money_adult"];
		$arRooms[$roomNum]["kingaku_otona"] = $arPayList[$tdate][$roomNum]["money_adult"];
		$arRooms[$roomNum]["kingaku_kodomo1"] = $arPayList[$tdate][$roomNum]["money_child1"];
		$arRooms[$roomNum]["kingaku_kodomo2"] = $arPayList[$tdate][$roomNum]["money_child2"];
		$arRooms[$roomNum]["kingaku_kodomo3"] = $arPayList[$tdate][$roomNum]["money_child3"];
		$arRooms[$roomNum]["kingaku_kodomo4"] = $arPayList[$tdate][$roomNum]["money_child4"];
		$arRooms[$roomNum]["kingaku_kodomo5"] = $arPayList[$tdate][$roomNum]["money_child5"];
		$arRooms[$roomNum]["kingaku_kodomo6"] = $arPayList[$tdate][$roomNum]["money_child6"];
	...
	new SoapVar(array(
				...
				new SoapVar(array(
						...
						new SoapVar(array(
								...
								new SoapVar("沖縄", XSD_STRING, null, null, 'SalesOfficeName'),
								new SoapVar(SITE_TL_ID, XSD_STRING, null, null, 'SalesOfficeCode'),
								new SoapVar("", XSD_STRING, null, null, 'SalesOfficePersonInCharge'),
								new SoapVar("", XSD_STRING, null, null, 'SalesOfficeEmail'),
								new SoapVar("", XSD_STRING, null, null, 'SalesOfficePhoneNumber'),
								new SoapVar("", XSD_STRING, null, null, 'SalesOfficeFaxNumber'),
						...
						new SoapVar(array(
								...
								new SoapVar("0", XSD_STRING, null, null, 'GuestOrGroupContactDiv'),
								new SoapVar($sess->getSessionByKey($sess->getSessionLogninKey(), "MEMBER_TEL1"), XSD_STRING, null, null, 'GuestOrGroupCellularNumber'),
								...
								new SoapVar($checkNum, XSD_INTEGER, null, null, 'GrandTotalPaxCount'),
						...
						new SoapVar(array(
								...
								new SoapVar("Cash", XSD_STRING, null, null, 'Payment'),
								new SoapVar("0", XSD_STRING, null, null, 'SettlementDiv'),
								new SoapVar($arPayList["money_all"], XSD_INTEGER, null, null, 'TotalAccommodationCharge'),
								new SoapVar(0, XSD_INTEGER, null, null, 'TotalAccommodationConsumptionTax'),
								new SoapVar(0, XSD_INTEGER, null, null, 'TotalAccommodationHotSpringTax'),
								new SoapVar(0, XSD_INTEGER, null, null, 'TotalAccomodationServiceCharge'),
								new SoapVar($arPayList["money_all"], XSD_INTEGER, null, null, 'TotalAccommodationDiscountPoints'),
								new SoapVar(0, XSD_INTEGER, null, null, 'TotalAccommodationConsumptionTaxAfterDiscountPoints'),
								new SoapVar($arPayList["money_all"], XSD_INTEGER, null, null, 'AmountClaimed'),
								new SoapVar(array(
						...
						new SoapVar(array(
								new SoapVar($sess->getSessionByKey($sess->getSessionLogninKey(), "MEMBER_NAME_KANA1")." ".$sess->getSessionByKey($sess->getSessionLogninKey(), "MEMBER_NAME_KANA2"), XSD_STRING, null, null, 'MemberName'),
								...
								new SoapVar("0", XSD_STRING, null, null, 'MailDemandDiv'),
								new SoapVar("0", XSD_STRING, null, null, 'PamphletDemandDiv'),
