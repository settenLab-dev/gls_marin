...
<title>沖縄の求人情報 ｜ 地域限定！お得なレジャーとグルメの専門サイト「ココトモ」</title>
<meta name="keywords" content="<?php print SITE_PUBLIC_KEYWORD?>" />
<meta name="description" content="沖縄県内を中心とした求人情報を掲載中！ココトモだけの限定求人情報も！<?php print SITE_PUBLIC_DESCRIPTION?>" />
...
<section>
    <div class="mainimage">
<img src="./images/index2016/img_job.jpg" width="1323" height="250" alt="お仕事情報" /></a></li>
	</div>
</section>
...
<?php // require("includes/box/common/job_data.php");?>
			...
			<aside class="banerList">
				<ul>
					<li style="margin-bottom:10px;"><a href="https:cocotomo.net/contact-form.html"><img src="./images/job/job_contact.jpg" width="222" height="119" alt="職業相談をご希望の方はコチラへ" /></a></li>
...
<h2 class="title2016 cf" style="margin-bottom:15px;">エリアから探す</h2>
	<!--エリアform-->
