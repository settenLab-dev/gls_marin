...
class hotelBookset extends collection {
	...
	public function selectList($collection) {
		$sql  = "select ";
		$sql .= "a.COMPANY_ID, ";
		$sql .= "from ".hotelBookset::tableName." a ";
		...
		if ($collection->getByKey($collection->getKeyValue(), "COMPANY_ID") != "") {
			...
			$where .= parent::expsData("a.".hotelBookset::keyName, "=", $collection->getByKey($collection->getKeyValue(), "COMPANY_ID"))." ";
		}
...
// 		}
		...
		*/
		...
		parent::setCollection($sql, hotelBookset::keyName);
	}
	...
	public function select($id="", $statusComma="") {
		...
		$sql .= "from ".hotelBookset::tableName." ";
		...
		if ($id != "") {
			...
			$where .= parent::expsData("".hotelBookset::keyName, "=", $id)." ";
		}
	...
	public function insert($dataList) {
		$sql  = "insert into ".hotelBookset::tableName." (";
		$sql .= "COMPANY_ID, ";
...
//print $sql;
	...
	public function update($dataList) {
		$sql .= "update ".hotelBookset::tableName." set ";
		...
		$sql .= "where ";
		$sql .=  parent::expsData(hotelBookset::keyName, "=", parent::getKeyValue())." ";
