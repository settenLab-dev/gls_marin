...
class couponBookset extends collection {
	...
	public function selectList($collection) {
		$sql  = "select ";
		$sql .= "a.COMPANY_ID, ";
		$sql .= "from ".couponBookset::tableName." a ";
		...
		if ($collection->getByKey($collection->getKeyValue(), "COMPANY_ID") != "") {
			...
			$where .= parent::expsData("a.".couponBookset::keyName, "=", $collection->getByKey($collection->getKeyValue(), "COMPANY_ID"))." ";
		}
...
// 		}
		...
		*/
		...
		parent::setCollection($sql, couponBookset::keyName);
	}
	...
	public function select($id="", $statusComma="") {
		...
		$sql .= "from ".couponBookset::tableName." ";
		...
		if ($id != "") {
			...
			$where .= parent::expsData("".couponBookset::keyName, "=", $id)." ";
		}
	...
	public function insert($dataList) {
		$sql  = "insert into ".couponBookset::tableName." (";
		$sql .= "COMPANY_ID, ";
	...
	public function update($dataList) {
		$sql .= "update ".couponBookset::tableName." set ";
		...
		$sql .= "where ";
		$sql .=  parent::expsData(couponBookset::keyName, "=", parent::getKeyValue())." ";
