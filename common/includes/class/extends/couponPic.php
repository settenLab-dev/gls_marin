...
class couponPic extends collection {
	...
	public function selectList($collection) {
		...
		if ($collection->getByKey($collection->getKeyValue(), "HOTELPIC_ID") != "") {
			...
			$where .= parent::expsData("".couponPic::keyName, "=", $collection->getByKey($collection->getKeyValue(), "HOTELPIC_ID"))." ";
		}
		...
		if ($collection->getByKey($collection->getKeyValue(), "COMPANY_ID") != "") {
			...
			$where .= parent::expsData("".couponPic::tableKeyName, "=", $collection->getByKey($collection->getKeyValue(), "COMPANY_ID"))." ";
		}
...
// 		}
		...
		*/
		...
		parent::setCollection($sql, couponPic::keyName);
	}
	...
	public function select($id="", $statusComma="", $companyId="", $hotelPicGroupId="") {
		...
		if ($id != "") {
			...
			$where .= parent::expsData("".couponPic::keyName, "=", $id)." ";
		}
		...
		if ($companyId != "") {
			...
			$where .= parent::expsData("".couponPic::tableKeyName, "=", $companyId)." ";
		}
	...
	public function insert($dataList) {
		$sql  = "insert into ".couponPic::tableName." (";
		$sql .= "HOTELPIC_ID, ";
		$sql .= "COMPANY_ID, ";
	...
	public function update($dataList) {
		$sql .= "update ".couponPic::tableName." set ";
		...
		$sql .= "where ";
		$sql .=  parent::expsData(couponPic::keyName, "=", parent::getKeyValue())." ";
