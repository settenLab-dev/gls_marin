...
<!--main-->
	...
	<img src="/images/hotel/pickup_c.png" width="1085" height="44" alt="ピックアップ" />
		...
		<div class="contents_box cf">
			<div class="toku">
				<a href="http://cocotomo.net/plan-detail.html?company_id=109&hotelplan_id=494&room_id=668&undecide_sch=1"><img src="/images/hotel/pick15.png" width="399" height="236" alt="今週のお得な限定プランはコチラ！！" /></a>
			</div>
			<div class="toku_l">
				<ul class="toku">
				<li><a href="http://cocotomo.net/sp-backnumber2.html"><img src="./images/hotel/sp_bk.jpg" width="261" height="94" alt="スパイスで放送したお得な宿泊プランのバックナンバーはコチラ！" /></br>▼TV番組で放送!!お得なプランはコチラ！</a></br></br></li>
...
<!--	</div>-->
	...
	<!--
        	<form name="frm9" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 9); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm8" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 8); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm7" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 7); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm6" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 6); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm21" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 21); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm5" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 5); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm4" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 4); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm2" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 2); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm3" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 3); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm10" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 10); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm11" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 11); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm12" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 12); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm13" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 13); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm14" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 14); print $inputs->hidden("undecide_sch", 1)?></form>
            	<form name="frm15" method="post" action="facility-search.html"><?php print $inputs->hidden("area", 15); print $inputs->hidden("undecide_sch", 1)?></form>
	-->
...
<!--人数から検索-->
 ...
 <!--人気の日程-->
               <section class="search">
               	...
               	<td>
               <ul class="w255">
               		<li><form method="post" action="facility-search.html#" name="form4"><input type="hidden" name="search_date" value="2014年7月12日">
                        <a href="" onClick="document.form4.submit();return false">7月12日(土)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form5"><input type="hidden" name="search_date" value="2014年7月13日">
                        <a href="" onClick="document.form5.submit();return false">7月13日(日)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form6"><input type="hidden" name="search_date" value="2014年7月19日">
                        <a href="" onClick="document.form6.submit();return false">7月19日(土)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form7"><input type="hidden" name="search_date" value="2014年7月20日">
                        <a href="" onClick="document.form7.submit();return false">7月20日(日)に泊まれる宿</a></form></li>
               	</ul>
               	</td>
               	<td>
               	<ul class="w255">
	      		<li><form method="post" action="facility-search.html#" name="form8"><input type="hidden" name="search_date" value="2014年7月26日">
                        <a href="" onClick="document.form8.submit();return false">7月26日(土)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form1"><input type="hidden" name="search_date" value="2014年7月27日">
                        <a href="" onClick="document.form1.submit();return false">7月27日(日)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form2"><input type="hidden" name="search_date" value="2014年8月2日">
                        <a href="" onClick="document.form2.submit();return false">8月2日(土)に泊まれる宿</a></form></li>
	      		<li><form method="post" action="facility-search.html#" name="form3"><input type="hidden" name="search_date" value="2014年8月3日">
                        <a href="" onClick="document.form3.submit();return false">8月3日(日）に泊まれる宿</a></form></li>
               	</ul>
               		</td>
               		</tr>
               	</table>
