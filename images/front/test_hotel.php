...
<head>
<meta charset="utf-8">
<?php require("includes/box/common/meta_new3.php"); ?>
...
<!--main-->
	...
	<img src="/images/hotel/pickup_c.png" width="1085" height="44" alt="ピックアップ" />
		...
		<div class="contents_box cf">
			<div class="toku">
				<a href="http://cocotomo.net/plan-detail.html?company_id=46&hotelplan_id=519&room_id=448&undecide_sch=1"><img src="/images/hotel/pick11.png" width="399" height="256" alt="今週のお得な限定プランはコチラ！！" /></a>
			</div>
			<div class="toku_l">
				<ul class="toku">
...
<!--人数から検索-->
 ...
 <!--人気の日程-->
               <section class="search">
               	...
               	<td>
               <ul class="w255">
               		<li><form method="post" action="facility-search.html#" name="form4"><input type="hidden" name="search_date" value="2014年5月24日">
                        <a href="" onClick="document.form4.submit();return false">5月24日(土)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form5"><input type="hidden" name="search_date" value="2014年5月25日">
                        <a href="" onClick="document.form5.submit();return false">5月25日(日)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form6"><input type="hidden" name="search_date" value="2014年5月31日">
                        <a href="" onClick="document.form6.submit();return false">5月31日(土)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form7"><input type="hidden" name="search_date" value="2014年6月1日">
                        <a href="" onClick="document.form7.submit();return false">6月1日(日)に泊まれる宿</a></form></li>
               	</ul>
               	</td>
               	<td>
               	<ul class="w255">
	      		<li><form method="post" action="facility-search.html#" name="form8"><input type="hidden" name="search_date" value="2014年6月7日">
                        <a href="" onClick="document.form8.submit();return false">6月7日(土)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form1"><input type="hidden" name="search_date" value="2014年6月8日">
                        <a href="" onClick="document.form1.submit();return false">6月8日(日)に泊まれる宿</a></form></li>
               		<li><form method="post" action="facility-search.html#" name="form2"><input type="hidden" name="search_date" value="2014年6月14日">
                        <a href="" onClick="document.form2.submit();return false">6月14日(土)に泊まれる宿</a></form></li>
	      		<li><form method="post" action="facility-search.html#" name="form3"><input type="hidden" name="search_date" value="2014年6月15日">
