...
-->
		...
		<li class="menu_g2"><a href="<?php URL_PUBLIC?>gourmet-menu<?php print $gourmet->getByKey($gourmet->getKeyValue(), "COMPANY_ID");?>.html" class="stay2">メニュー</a></li>
		...
		<li class="menu_g4"><a href="<?php URL_PUBLIC?>gourmet-coupon<?php print $gourmet->getByKey($gourmet->getKeyValue(), "COMPANY_ID");?>.html" class="link4">クーポン</a></li>
			...
			<section>
				...
				<?php }else{?>
					...
					<center><B>ただいまメニュー掲載準備中です。</B></center>
				<?php }?>
