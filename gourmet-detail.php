...
-->
		...
		$(function(){$(window).load(function() {
			...
			<?php if($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_TITLE3") != ""){?>
			<h2 class="title"><?php print $gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_TITLE3")?></h2>
			<?php }?>
			<div class="inner cf">
			<?php if($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_CONTENT3") != ""){?>
					<div>
						<p><?php print nl2br($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_CONTENT3"))?></p>
					</div>
			<?php }?>

			<?php if($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_TOPICKS") != ""){?>
					<article class="news_cn">
						<h3><img src="./images/category/news_title.png" width="135" height="22" alt="NEWS TOPICS" /></h3>
						<ul>
							<li><?php print nl2br(redirectForReturn($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_TOPICKS")))?></li>
						</ul>
					</article>
			<?php }?>
			...
			<?php if($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_CATCHCOPY") != ""){?>
				<article class="ceack">
					<div>
			...
			<article class="inner detailText1 cf"  id="lightboxes">
				...
				<div>
					<p><?php print nl2br(redirectForReturn($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_STAFFPUSHU")))?></p>
				</div>
			</article>
			<?php }?>
			...
			<?php if($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_TITLE1") != ""){?>
				<h2 class="title"><span>お店紹介①</span><?php print $gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_TITLE1")?></h2>
				<div class="inner cf">
					<div class="fl-l">
						<p><?php print nl2br($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_CONTENT1"))?></p>
					</div>
			...
			<?php if($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_TITLE2") != ""){?>
				...
				<div class="inner cf">
					...
					<?php }?>
					<div>
						<p><?php print nl2br($gourmet->getByKey($gourmet->getKeyValue(), "GOURMET_RECOMM_CONTENT2"))?></p>
					</div>
				</div>
			<?php }?>
