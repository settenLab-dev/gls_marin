...
$site_top = "http://cocotomo.net/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@cocotomo.net";
...
$Referer_check_domain = "cocotomo.net";
...
$BccMail = "info@cocotomo.net";

// 管理者宛に送信されるメールのタイトル（件名）
$subject = "【ココトモ】FC琉球サッカー1万人祭りチケット申し込み";
...
$require = array('お名前','フリガナ','希望枚数','Email','電話番号');
...
$refrom_name = "地域限定レジャーサイト「ココトモ」";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【ココトモ】FC琉球 全島サッカー1万人祭りチケットプレゼント申込み受付完了";
...
※このメールは送信専用アドレスより自動でお送りしています。

FC琉球 全島サッカー1万人祭りチケットプレゼントへのお申し込みありがとうございます。
以下の内容でお申し込みを受け付けました。

2015年6月27日(土)19：00以降より順次抽選結果をメールにてお知らせいたします。
今しばらくお待ちくださいませ。
...
MAIL：info@cocotomo.net

運営：glass space株式会社
沖縄県那覇市久米1-1-13 プランビル久米6F
TEL：098-988-8105
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Copyright (c) 2013 glass space Inc. All Rights Reserved.
...
<title>FC琉球 全島サッカー1万人祭りチケットプレゼント(入力内容の確認） ｜ <?php print SITE_PUBLIC_NAME?></title>
<meta name="keywords" content="予約,<?php print SITE_PUBLIC_KEYWORD?>" />
<meta name="description" content="FC琉球 全島サッカー1万人祭りチケットプレゼントお申し込みフォームです。<?php print SITE_PUBLIC_DESCRIPTION?>" />
...
<div id="content_mini" class="clearfix">
	...
	<main id="detail_n" class="reservation_n">
		...
		<ul id="panlist">
            ...
            <li><span>FC琉球 全島サッカー1万人祭りチケットプレゼント</span></li>
        </ul>
...
<meta charset="utf-8">
<?php require("includes/box/common/meta_new1.php"); ?>
<title>FC琉球 全島サッカー1万人祭りチケットプレゼント（申込完了） ｜ <?php print SITE_PUBLIC_NAME?></title>
<meta name="keywords" content="予約,<?php print SITE_PUBLIC_KEYWORD?>" />
