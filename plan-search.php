							...
							<section class="accordion">
								...
								<ul class="nest">
									...
									<li class="subtitle">利用シーン</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="1" id="tag1" <?php if(in_array(1, $arrTag)) echo "checked='checked'"; ?>> 1人参加可</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="2" id="tag2" <?php if(in_array(2, $arrTag)) echo "checked='checked'"; ?>> こどもとおでかけ</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="8" id="tag8" <?php if(in_array(8, $arrTag)) echo "checked='checked'"; ?>> デート</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="7" id="tag7" <?php if(in_array(7, $arrTag)) echo "checked='checked'"; ?>> 記念日</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="9" id="tag9" <?php if(in_array(9, $arrTag)) echo "checked='checked'"; ?>> 女子会・女子旅</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="10" id="tag10" <?php if(in_array(10, $arrTag)) echo "checked='checked'"; ?>> 夜景</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="4" id="tag4" <?php if(in_array(4, $arrTag)) echo "checked='checked'"; ?>> 雨の日</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="" id="" <?php if(in_array(0, $arrTag)) echo "checked='checked'"; ?>> 3000円以下</label>
										</li>
										
									<li class="subtitle">支払い方法</li>
										<li class="check">
											<label><input type="checkbox" name="pay[]" value="11" id="tag11" <?php if(in_array(11, $arrPay)) echo "checked='checked'"; ?>> 現地払い</label>
										</li>
										<li class="check">
									...
									<li class="subtitle">団体予約</li>
										...
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="" id="" <?php if(in_array(0, $arrTag)) echo "checked='checked'"; ?>> 20人以上</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="" id="" <?php if(in_array(0, $arrTag)) echo "checked='checked'"; ?>> 30人以上</label>
										</li>
										<li class="check">
									...
									<li class="subtitle">サービス</li>
										...
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="15" id="tag15" <?php if(in_array(15, $arrTag)) echo "checked='checked'"; ?>> 送迎付</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="17" id="tag17" <?php if(in_array(17, $arrTag)) echo "checked='checked'"; ?>> ガイド同行</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="18" id="tag18" <?php if(in_array(18, $arrTag)) echo "checked='checked'"; ?>> ペット参加可</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="12" id="tag12" <?php if(in_array(12, $arrTag)) echo "checked='checked'"; ?>> 貸切可</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="11" id="tag11" <?php if(in_array(11, $arrTag)) echo "checked='checked'"; ?>> 料金割引</label>
										</li>
										<li class="check">
										...
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="19" id="tag19" <?php if(in_array(19, $arrTag)) echo "checked='checked'"; ?>> 初心者OK</label>
										</li>
										
									<li class="subtitle">空間・設備</li>
										<li class="check">
											<label><input type="checkbox" name="facility[]" value="1" id="facility1" <?php if(in_array(1, $arrFacility)) echo "checked='checked'"; ?>> シャワー</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="facility[]" value="2" id="facility2" <?php if(in_array(2, $arrFacility)) echo "checked='checked'"; ?>> トイレ</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="facility[]" value="3" id="facility3" <?php if(in_array(3, $arrFacility)) echo "checked='checked'"; ?>> ドライヤー</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="facility[]" value="4" id="facility4" <?php if(in_array(4, $arrFacility)) echo "checked='checked'"; ?>> ロッカー</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="facility[]" value="5" id="facility5" <?php if(in_array(5, $arrFacility)) echo "checked='checked'"; ?>> 売店</label>
										</li>
										<li class="check">
									...
									<li class="subtitle">駐車場あり</li>
										...
										<li class="check">
											<label><input type="checkbox" name="access[]" value="2" id="access2" <?php if(in_array(2, $arrAccess)) echo "checked='checked'"; ?>> 無料駐車場</label>
										</li>
										
									<li class="subtitle">日程</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="5" id="tag5" <?php if(in_array(5, $arrTag)) echo "checked='checked'"; ?>> 午前</label>
										</li>
										<li class="check">
											<label><input type="checkbox" name="tag[]" value="6" id="tag6" <?php if(in_array(6, $arrTag)) echo "checked='checked'"; ?>> 午後</label>
										</li>
