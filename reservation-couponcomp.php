...
<link rel="stylesheet" href="/css/style201505.css" type="text/css" media="screen" />
...
window.onload = function(){
    parent.postMessage('1', 'https://cocotomo.net');
}
</script>
<!--<script type="text/javascript">
...
<tr class=S1><th class=S1 align=left><big>クーポン決済完了</big></th></tr>
</table>

<br>

決済完了の手続き中です。しばらくお待ちください。
この画面が1分以上続く場合はココトモ事務局(TEL：098-988-8105/info@cocotomo.net)までご連絡ください。
...
${result_setsumei}
<br>${err_msg}
<a href="javascript:send_to_parent();" id="btn"><img src="images/reservation/coupon-submit2.jpg"></a>
