   ...
   <!-- side nav -->
      ...
      <section class="accordion">
        ...
        <ul class="nest">
		  <li>
              <p class="link">
                <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>
                 <a href="/plan-search.html?area=11">北海道</a>
              </p>
          </li>  
          ...
          <li>
              <p class="link">   
				  <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>
                  <a href="/plan-search.html?area=10">東北</a>
              </p>
          </li>
          ...
          <li>
              <p class="link">  
                 <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>   
                  <a href="/plan-search.html?area=9">関東</a>
              </p>
          </li>
          ...
          <li>
              <p class="link">    
                 <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>
                  <a href="/plan-search.html?area=8">甲信越</a>
              </p>
          </li>
          ...
          <li>
              <p class="link">    
                 <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>
                  <a href="/plan-search.html?area=7">北陸</a>
              </p>
          </li>
          ...
          <li>
              <p class="link">  
                 <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>
                  <a href="/plan-search.html?area=6">東海</a>
              </p>
          </li>
          ...
          <li>
              <p class="link">   
                 <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>
                  <a href="/plan-search.html?area=5">関西</a>
              </p>
          </li>
          ...
          <li>
              <p class="link">  
                 <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>  
                  <a href="/plan-search.html?area=4">山陰・山陽</a>
              </p>
          </li>
          ...
          <li>
              <p class="link">   
                 <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>
                  <a href="/plan-search.html?area=3">四国</a>
              </p>
          </li>
          ...
          <li>
              <p class="link">   
                 <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>  
                  <a href="/plan-search.html?area=1">沖縄</a>
              </p>
          </li>
        </ul>
      </section>
	...
	<?php// foreach($mActivityCategory->getCollection() as $ac){?>
          <li>
              <p class="link">  
                    <i class="fa fa-caret-right fa-1 listtop" aria-hidden="true"></i>
                     <a href="/plan-search.html?cate=1">マリンレジャー</a>
                 </p>
          </li>
        </ul>
      </section>
