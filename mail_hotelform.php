...
$BccMail = "gocho@glaspe.net";

// 管理者宛に送信されるメールのタイトル（件名）
$subject = "お仕事情報のお問い合わせ";
...
$require = array('姓','名','セイ','メイ','Email','西暦','月','日');
...
$refrom_name = "ココトモお仕事情報";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【ココトモ】お仕事情報のお問い合わせありがとうございます";
...
お問い合わせありがとうございました。
職業相談ご紹介担当よりご返信致しますので今しばらくお待ちください。
...
<title>職業相談お問い合わせ(入力内容の確認） ｜ <?php print SITE_PUBLIC_NAME?></title>
...
<meta charset="utf-8">
<?php require("includes/box/common/meta_new1.php"); ?>
<title>職業相談お問い合わせ（送信完了） ｜ <?php print SITE_PUBLIC_NAME?></title>
<meta name="keywords" content="予約,<?php print SITE_PUBLIC_KEYWORD?>" />
<meta name="description" content="ホテルの予約ページです。<?php print SITE_PUBLIC_DESCRIPTION?>" />
<meta http-equiv="Content-Style-Type" content="text/css" />
<style type="text/css">
