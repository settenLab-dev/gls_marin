...
//if ($result !=1)
//{
//	print create_error_caption($couponBooking->getError())
//}
...
if ($couponBooking->getErrorCount() > 0) {
			...
			?>
        	<form method="post" action="https://cocotomo.net/reservation-coupon2.html">
            	<?php require("includes/box/coupon/inputReserv-coupon.php");?>
            </form>
        </div>
