...
<div id="content_mini" class="clearfix">
    ...
    <main id="detail_n" class="gourmet">
		...
		<li class="menu_g3"><a href="<?php URL_PUBLIC?>gourmet-coupon-prev.html?id=<?php print $gourmet->getByKey($gourmet->getKeyValue(), "COMPANY_ID");?>" class="stay3">クーポン</a></li>
		</ul>
		</div>
			...
			<article class="coupon-list-g">
				...
				<ul class="coupon-leisure">
					...
					?>
						...
						<!--	<ul class="link">
								<li><a href=""><img src="./images/category/print-bt.png" width="190" height="27" alt="このクーポンを印刷する" /></a></li>
