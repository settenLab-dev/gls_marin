...
$hotelPriceType->select(cmIdCheck(constant("hotelPriceType::keyName")), "1", $sess->getSessionByKey($sess->getSessionLogninKey(), "COMPANY_ID"));
$hotelPriceType->setByKey($hotelPriceType->getKeyValue(), "COMPANY_ID", $sess->getSessionByKey($sess->getSessionLogninKey(), "COMPANY_ID"));
