<table border="0" cellpadding="0" cellspacing="15" class="" summary="マスタデータ" width="100%">
	...
	<tr>
		...
		<td align="left">
			...
			<?=$inputs->image("GOURMETPIC_DATA", $gourmetPic->getByKey($gourmetPic->getKeyValue(), "GOURMETPIC_DATA"), IMG_GOURMET_APP_WIDTH, IMG_GOURMET_APP_HEIGHT, IMG_GOURMET_APP_SIZE, "", 3)?>
		</td>
	</tr>
	<tr>
		<td width="160" valign="top">
	...
	<tr>
		...
		<td align="left">
			...
			<?php print $inputs->radio("GOURMETPIC_STATUS2", "GOURMETPIC_STATUS", 1, $gourmetPic->getByKey($gourmetPic->getKeyValue(), "GOURMETPIC_STATUS") ," 公開")?>
