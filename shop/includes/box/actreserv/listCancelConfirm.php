...
// 							print "無不泊連絡";
							...
							<?php print $inputs->radio("targetCancel1", "targetCancel", 1, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "無連絡不着 : 料金の".$hotelBookset->getByKey($hotelBookset->getKeyValue(), "BOOKSET_CANCEL_PAY1")."%")?><br />
						...
						?>
							...
							<?php print $inputs->radio("targetCancel1", "targetCancel", 1, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "無連絡不着 : ".$hotelBookset->getByKey($hotelBookset->getKeyValue(), "BOOKSET_CANCEL_PAY1")."円")?><br />
...
// 						print "無連絡不着";
					...
					<?php print $inputs->radio("targetCancel1", "targetCancel", 1, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "無連絡不着 : 料金の".$hotelBooking->getByKey($hotelBooking->getKeyValue(), "HOTELPLAN_CANCEL_MONEY1")."%")?><br />

					<?php
// 						$can = "料金の".$hotelBooking->getByKey($hotelBooking->getKeyValue(), "HOTELPLAN_CANCEL_MONEY1")."%";
					}
					else {
					?>

							<?php print $inputs->radio("targetCancel1", "targetCancel", 1, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "無連絡不着 : ".$hotelBooking->getByKey($hotelBooking->getKeyValue(), "HOTELPLAN_CANCEL_MONEY1")."円")?><br />
...
// 					print "当日キャンセル";
					...
					?>
						...
						<?php print $inputs->radio("targetCancel2", "targetCancel", 2, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "当日キャンセル : 料金の".$hotelBooking->getByKey($hotelBooking->getKeyValue(), "HOTELPLAN_CANCEL_MONEY2")."%")?><br />
