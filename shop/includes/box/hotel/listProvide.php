...
<table cellspacing="0" cellpadding="5" class="tblInput " id="sortList" width="100%">
	...
	<tr>
		...
		<a href="shopProvideEditMonthly.html?id=<?php print $rid?>&key=<?php print $d["ROOM_ID"]?>&date=<?php print date("Y-m",strtotime($collection->getByKey($collection->getKeyValue(), "HOTELPROVIDE_DATE")))?>" class="popup" rel="windowCallUnload3"><?=$inputs->button("","","月間編集","circle")?></a>
		</th>
