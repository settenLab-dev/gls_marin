			...
			<table class="inner" cellspacing="5">
				<tr>
					...
					<td align="left">
						...
						<a href="shopGalleryEdit.html?id=SHOP_ACCESS_PIC<?php print $i?>" class="popup" rel="windowCallUnload"></a>
						...
						<a href="shopGalleryEdit.html?id=SHOP_ACCESS_PIC<?php print $i?>" class="popup" rel="windowCallUnload"><?=$inputs->button("","","設定済写真から選択","circle")?></a>
						<?php }?>
