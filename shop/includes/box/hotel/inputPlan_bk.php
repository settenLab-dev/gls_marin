<table border="0" cellpadding="0" cellspacing="15" class="" summary="マスタデータ" widtd="100%">
	...
	<tr>
		<td valign="top">
			<p>プランの特徴 <span class="colorRed">※</span></p>
		</td>
		<td align="left">
	...
	<tr>
		...
		<td align="left">
			...
			<?=$inputs->checkbox("HOTELPLAN_DEMAND","HOTELPLAN_DEMAND",1,$hotelPlan->getByKey($hotelPlan->getKeyValue(), "HOTELPLAN_DEMAND")," 予約者へ宿への要望を聞く", "")?>
		</td>
	</tr>
</table>
<br />
