...
// 							print "無不泊連絡";
							...
							<?php print $inputs->radio("targetCancel1", "targetCancel", 1, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "無不泊連絡 : 料金の".$hotelBookset->getByKey($hotelBookset->getKeyValue(), "BOOKSET_CANCEL_PAY1")."%")?><br />
...
// 						print "当日キャンセル";
						...
						<?php print $inputs->radio("targetCancel2", "targetCancel", 2, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "当日キャンセル : 料金の".$hotelBookset->getByKey($hotelBookset->getKeyValue(), "BOOKSET_CANCEL_PAY2")."%")?><br />
...
// 						print "無不泊連絡";
					...
					<?php print $inputs->radio("targetCancel1", "targetCancel", 1, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "無不泊連絡 : 料金の".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY1")."%")?><br />

					<?php
// 						$can = "料金の".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY1")."%";
					}
					else {
					?>

							<?php print $inputs->radio("targetCancel1", "targetCancel", 1, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "無不泊連絡 : ".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY1")."円")?><br />

						<?php
// 						$can = "".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY1")."円";
					}
// 					$dataCancel .= "無不泊連絡 ".$can."\n";
				}
...
// 					print "当日キャンセル";
					...
					?>
						...
						<?php print $inputs->radio("targetCancel2", "targetCancel", 2, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "当日キャンセル : 料金の".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY2")."%")?><br />

					<?php
// 						$can = "料金の".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY2")."%";
					}
					else {
					?>

						<?php print $inputs->radio("targetCancel2", "targetCancel", 2, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , "当日キャンセル : ".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY2")."円")?><br />

					<?php
// 						$can = "".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY2")."円";
					}
// 					$dataCancel .= "当日キャンセル ".$can."\n";
				}
				...
				for ($i=3; $i<=6; $i++) {
					if ($shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_FLG".$i) != "" and $shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY".$i) != "") {
						...
						?>
							...
							<?php print $inputs->radio("targetCancel".$i, "targetCancel", $i, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , $shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_FROM".$i)."～".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_TO".$i)."日前まで : 料金の".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY".$i)."%")?>

						<?php
// 							$can = "料金の".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY".$i)."%";
						}
						else {
						?>

							<?php print $inputs->radio("targetCancel".$i, "targetCancel", $i, $hotelBookingcont->getByKey($hotelBookingcont->getKeyValue(), "targetCancel") , $shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_FROM".$i)."～".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_TO".$i)."日前まで : 料金の".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY".$i)."円")?>

						<?php
// 							$can = "".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_MONEY".$i)."円";
						}
// 						$dataCancel .= $shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_FROM".$i)."～".$shopBooking->getByKey($shopBooking->getKeyValue(), "SHOPPLAN_CANCEL_TO".$i)."日前まで".$can."\n";
					}
				}
			}
