...
$shopBooking->selectListAdminProvide($collection);
...
if ($shopBooking->getCount() > 0) {
	foreach ($shopBooking->getCollection() as $book) {
...
<head>
	...
	<title>ショップ情報｜<?=SITE_SLAKER_NAME?></title>
