...
$gourmetPic->select("", "1,2", $sess->getSessionByKey($sess->getSessionLogninKey(), "COMPANY_ID"), $collection->getByKey($collection->getKeyValue(), "GOURMETPICGROUP_ID"));
$gourmetPic->setByKey($gourmetPic->getKeyValue(), "COMPANY_ID", $sess->getSessionByKey($sess->getSessionLogninKey(), "COMPANY_ID"));
$gourmetPic->setPost();
...
<body id="">
	<div id="containerPop">
		...
		<div id="contentsPop" class="circle">
			...
			<p>登録写真数：<?php print $gourmetPic->getCount()?> 枚</p>
